@extends('layouts.templateportal')
...
<div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="bg-primary">
            ...
            <div class="logo">
              <center>
                <img src="{{asset('img/logos/logoblancobeenet.png')}}" width="100px" alt="">
              </center>
            </div>
            <div class="menu">
                ...
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                  <li class="nav-item dropdown">
                    <a class="nav-link text-dark dropdown-toggle" href="#" id="navbarDropdown" role="button"
                      ...
                      <i class="icon ion-md-contact lead mr-2"></i>
                    Diego Velázquez
                    </a>
                  ...
                  <div class="container">
                      <div class="row">
                          <div class="col-lg-9 col-md-8">
                            ...
                            <p class="lead text-muted">Portal de cliente</p>
                          </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 d-flex stat my-3">
                                    <div class="mx-auto">
                                        <h6 class="text-muted">Plan activo</h6>
                                ...
                                <div class="col-lg-6 col-md-6 d-flex stat my-3">
                                    <div class="mx-auto">
                                        <h6 class="text-muted">MB disponible</h6>
